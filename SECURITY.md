...
If you find a security vulnerability in **PsychoQuine**, report it privately before disclosing it publicly.

**Preferred channel:**
Email — `legal.sxnnyside@sxnnysideproject.com`

**Alternative:**
[GitHub Private Security Advisory](https://github.com/core-red-project/psychoquine-cli/security/advisories/new)
...
This policy covers the **PsychoQuine** repository only.
